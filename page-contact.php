        ...
        <div class="row mt-5">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="info-box mt-4">
                  ...
                  <p>diabeto@gmail.com<br>santediabeto@gmail.com</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box mt-4">
                  ...
                  <h3>Appelez Nous</h3>
                  <p>+221 33 827 53 57<br>+221 33 971 42 46</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="text-center"><button class="appointment-btn btn-primary" type="submit">Envoyer</button></div>
            </form>
          </div>
